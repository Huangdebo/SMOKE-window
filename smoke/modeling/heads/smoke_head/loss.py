...
class SMOKELossComputation():
    ...
    def prepare_predictions(self, targets_variables, pred_regression):
        ...
        # obtain prediction from points of interests, size: (batch, num_object, channel)
        ...
        # 把计算pre_box3d 的三个变量中的两个换成 target(groundtruth)中的值，分别计算 3 个不一样的 pre_box3d
        ...
        # 直接用预测的 roty, dimension 和 location 来计算 pre_box_3d
